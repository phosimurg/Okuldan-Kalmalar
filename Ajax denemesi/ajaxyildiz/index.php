...
<html>
 ...
 <body>
  <div class="container" style="width:800px;">
   <h2 align="center">Ajax Sunumumuzu Oylayacağınız Sitemize Hoşgeldiniz!..</h2>
   <br />
 ...
 $(document).on('click', '.rating', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    {
     load_business_data();
     alert("Oyunuz 5'te "+index);
    }
    else
    {
     alert("Oyunuz Geçerli Değil, Bir Problem Var...");
    }
   }
  });
